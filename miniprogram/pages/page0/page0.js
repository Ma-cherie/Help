...
var container14 = new ui.StackViewFlexModel({ id: "container14", state:"state1" });
...
let view51 = new ui.ViewFlexModel({ id: "view51", styleObject: {} ,container:container14_proxy})
data["view51"] = view51
WAC.bindProxy(this,view51, "view51")

let image73 = new ui.ImageViewFlexModel({ id: "image73", mode: "aspectFill", src: "https://servicewechat.com/wxa-dev-logic/visualprogramming?action=download-image&media-id=8h3T3lJtWBS7jv6grtStawQ_jWc-0WiwQ_6576bHLp4PS4DgPt17u-Nju0EHzK4J&content-type=1&openid=orSXl1IHO7hei3jzA9b3sfICqWps&appid=wx20edba31460266c0", styleObject: {} ,container:view51})
data["image73"] = image73
WAC.bindProxy(this,image73, "image73")

let text98 = new ui.LabelFlexModel({id: String.raw`text98`, styleObject: {"color":"rgba(0,0,0,1.00)"}, value: String.raw`昵称` ,container:view51})
data["text98"] = text98
WAC.bindProxy(this,text98, "text98")

let text99 = new ui.LabelFlexModel({id: String.raw`text99`, styleObject: {"color":"rgba(0,0,0,1.00)"}, value: String.raw`积分：100` ,container:view51})
data["text99"] = text99
WAC.bindProxy(this,text99, "text99")

let component3 = new ui.ComponentFlexModel({ id: "component3", position:'center',dashed:false,showText:true,text:'', styleObject: {} })
data["component3"] = component3
WAC.bindProxy(this,component3, "component3")

var that_container17 = this;
var container17 = new ui.StackViewFlexModel({ id: "container17", state:"state1" });
...
let view55 = new ui.ViewFlexModel({ id: "view55", styleObject: {} ,container:container17_proxy})
data["view55"] = view55
WAC.bindProxy(this,view55, "view55")

let text104 = new ui.LabelFlexModel({id: String.raw`text104`, styleObject: {"color":"rgba(0,0,0,1.00)"}, value: String.raw`我的提问` ,container:view55})
data["text104"] = text104
WAC.bindProxy(this,text104, "text104")

var that_container19 = this;
var container19 = new ui.StackViewFlexModel({ id: "container19", state:"state1" });
...
let view57 = new ui.ViewFlexModel({ id: "view57", styleObject: {} ,container:container19_proxy})
data["view57"] = view57
WAC.bindProxy(this,view57, "view57")

let text106 = new ui.LabelFlexModel({id: String.raw`text106`, styleObject: {"color":"rgba(0,0,0,1.00)"}, value: String.raw`我的回答` ,container:view57})
data["text106"] = text106
WAC.bindProxy(this,text106, "text106")

var that_container21 = this;
var container21 = new ui.StackViewFlexModel({ id: "container21", state:"state1" });
...
let view59 = new ui.ViewFlexModel({ id: "view59", styleObject: {} ,container:container21_proxy})
data["view59"] = view59
WAC.bindProxy(this,view59, "view59")

let text108 = new ui.LabelFlexModel({id: String.raw`text108`, styleObject: {"color":"rgba(0,0,0,1.00)"}, value: String.raw`关于` ,container:view59})
