...
Page({
    ...
    setupViews: function () {
        let data = {}
             ...
             */
            let component1 = new ui.ComponentFlexModel({ id: "component1", button:'搜索',color:'#333333',showIcon:true,mode:'normal',radius:6,align:'left',showClear:true,iconColor:'#07C160',btnColor:'#07C160',placeholder:'搜索',phColor:'#BBBBBB', styleObject: {} })
...
let scrolltab1 = new ui.ScrollTabFlexModel({ id: "scrolltab1", navData: [{"text":"全部"},{"text":"问答"},{"text":"求助"},{"text":"讨论"}], option:            {
            defaultColor: "#000000",
            activeColor: "#07c160",
            fixed: false,
            hasIndicator: true,
            ...
            fontSize: "16px"
            }, currentTab:0 ,styleObject: {} })
data["scrolltab1"] = scrolltab1
WAC.bindProxy(this,scrolltab1, "scrolltab1")

var that_container57 = this;
var container57 = new ui.StackViewFlexModel({ id: "container57", state:"state1" });
...
let list4 = new ui.ListFlexModel({ id: "list4", dataSource: [], styleObject: {} ,container:container57_proxy})
data["list4"] = list4
